...
3. Use the volatility estimate and the chosen probability density function to determine the confidence interval $z$. Determine the downside cut-off probability as a quantile (e.g. 1 % or 5%). For the normal distribution, the 95% confidence interval is $z=1.645$. 
...
5. Multiply the face value of contracts ($FV$) that embody the adverse risk by the $HPV$. That is, $VaR=FV \times HPV \times z$
