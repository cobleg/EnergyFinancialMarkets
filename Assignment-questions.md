...
1.  Identify the issues with volume limit use, with specific reference to the business plan and market risks of Diverse Energy. (2 marks)
	**Key points**
	...
	- One caveat is that sourcing from the spot market during a unit outage would likely imply a price higher than $60/MWh since the reduced supply implies a higher spot price. 