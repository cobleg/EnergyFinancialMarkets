...
1.  Identify the issues with volume limit use, with specific reference to the business plan and market risks of Diverse Energy. (2 marks)
	**Key points**
	...
	- Assuming each unit has 95% reliability in a standard year, continuous use of 3 units implies $0.95^{3} \approx 0.86$. This implies a unit will not be available for 14% of the year, which is the capacity factor of the fourth unit. There is an opportunity cost of 0.86 x  250 MW x 1 hour x 0.4 c.f. x $60/MWh =  $5,160 per hour when the unit is not being used. Over one year, that implies $5,160 per hour x 8760 hours x 0.95 = $42.2M per year.
	- By contrast, employing four units would imply $0.95^4 \approx 0.81$ availability in a standard year. This implies that electricity would not be supplied by one of the units for 19% of a standard year. This implies an expected cost of 0.19 x 0.4 c.f. x $60/MWh x 250 MW x 1 hour = $1,140 per hour for 1,664.4 hours, which is approximately $1.9M per year. 
	- There is an expected net cost of $45.2M - $1.9M = $4.3M per year of using the N-1 volume limit. 